...
static NSString * const kVerificationIntervalKey = @"license_verification_interval";
...
+ (instancetype)sharedManager {
    static LicenseManager *shared = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        shared = [[LicenseManager alloc] initWithAPIURL:@"https://187.127.45.32:3000"];
    });
    return shared;
}
